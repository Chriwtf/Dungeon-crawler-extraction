...
const LOOT_TABLE = [
    ...
    { kind: 'component', name: 'Calibrated component', value: 520, weight: 3 },
    { kind: 'artifact', name: 'Unidentified fragment', value: 900, weight: 4 },
];
const LOOT_PROFILES = {
...
export function placeRunLoot(dungeon, seed, count = 5) {
    const candidates = [];
