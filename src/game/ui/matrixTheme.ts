...
export const applyTextGlow = (
  text: Phaser.GameObjects.Text,
  color = matrixPalette.accent,
  blur = 10,
): Phaser.GameObjects.Text => text.setShadow(0, 0, color, blur, true, true);
...
export const drawTerminalPanel = ({
  graphics,
  x,
  y,
  width,
