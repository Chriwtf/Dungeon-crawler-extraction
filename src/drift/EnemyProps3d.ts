...
function addHumanoid(builder: CharacterMeshBuilder, atlas: Record<string, UvRect>, color: Color, shape: { height: number; shoulder: number; torso: number; limb: number; stance: number; crouch?: number }): void {
