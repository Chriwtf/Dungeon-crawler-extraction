...
const MATERIAL = [0.06, 0.06, 0.94, 0.94];
const GUARD = { torso: MATERIAL, head: MATERIAL, arm: MATERIAL, leg: MATERIAL };
const CRAWLER = { torso: MATERIAL, head: MATERIAL, arm: MATERIAL, leg: MATERIAL };
...
function addHumanoid(builder, atlas, palette, shape) {
